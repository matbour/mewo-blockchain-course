\begin{figure}
  \resizebox{\columnwidth}{!}{%
    \begin{tikzpicture}
      % Actors
      \node[label=Alice + clé $P_k$] (alice) at (0,0) {\includegraphics[height=4cm]{img/alice.png}};
      \node[label=Bob + clé $P_k$ et $S_k$] (bob) at (24,0) {\includegraphics[height=4cm]{img/bob.png}};
      \node[label=Eve + clé $P_k$] (eve) at (12,-4) {\includegraphics[height=4cm]{img/eve.png}};
